                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(Reglogin.this, "User Created.", Toast.LENGTH_SHORT).show();
                            ...
                            startActivity(new Intent(getApplicationContext(), zoo.class));

                        } else {
                            Toast.makeText(Reglogin.this, "Error ! " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();

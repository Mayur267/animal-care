...
//String[] names=res.getStringArray(R.array.names);
    String s1[]={"Roma Pet Clinic","Lele Veterinary Clinic","Companion Pet Clinic","Dr. Katre's Dogs And Cats Clinic",
            "Vet For Pets Clinic","Animal clinic","Fifth Sense Animal Health Care","Pets Clinic - Dr. Pradnya Dhokrikar","Dr Hatekars Dogs and Cat Clinic","Small Animal Clinic & Welfare,Narhe Road"};
...

    {
        ...
        googleURL.append("&key=" + "AIzaSyCkbd5qqsL5hBB4qAYGfWUO-Vcjb1do1UA");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for(int i=0;i<9;i++){
            mMap.addMarker(new MarkerOptions().position(arrayList.get(i)).title(s1[i]).snippet(s2[i]).icon(BitmapDescriptorFactory.fromResource(R.drawable.hospitals)));
